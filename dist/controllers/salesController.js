...
exports.salesTimeByBranch =
  exports.salesTime =
  exports.salesBranchByBranch =
  exports.salesBranch =
  exports.sales =
  exports.getSalesByCashier =
  exports.getSales =
...
var getSalesByCashier = (exports.getSalesByCashier =
  /*#__PURE__*/ (function () {
...
var deleteBranch = (exports.deleteBranch = /*#__PURE__*/ (function () {
  var _ref4 = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee4(req, res, next) {
      var _sales2;
      return _regeneratorRuntime().wrap(
            ...
            switch ((_context4.prev = _context4.next)) {
              ...
              case 3:
                ...
                return _context4.abrupt(
                  "return",
                  next((0, _error["default"])(404, "Sales not found!"))
                );
              case 6:
                _context4.next = 8;
          ...
          while (1)
            switch ((_context6.prev = _context6.next)) {
              ...
              case 19:
                ...
                res.json({
                  dailyTotal:
                    ((_dailyTotal$ = dailyTotal[0]) === null ||
                    _dailyTotal$ === void 0
                      ? void 0
                      : _dailyTotal$.total) || 0,
                  weeklyTotal:
                    ((_weeklyTotal$ = weeklyTotal[0]) === null ||
                    _weeklyTotal$ === void 0
                      ? void 0
                      : _weeklyTotal$.total) || 0,
                  monthlyTotal:
                    ((_monthlyTotal$ = monthlyTotal[0]) === null ||
                    _monthlyTotal$ === void 0
                      ? void 0
                      : _monthlyTotal$.total) || 0,
                  yearlyTotal:
                    ((_yearlyTotal$ = yearlyTotal[0]) === null ||
                    _yearlyTotal$ === void 0
                      ? void 0
                      : _yearlyTotal$.total) || 0,
                });
                _context6.next = 27;
                break;
              case 23:
                ...
                console.error(
                  "Error fetching aggregated sales data:",
                  _context6.t0
                );
                res.status(500).json({
...
var salesTimeByBranch = (exports.salesTimeByBranch =
  /*#__PURE__*/ (function () {
                ...
                case 0:
                  ...
                  aggregateSales = /*#__PURE__*/ (function () {
                    var _ref9 = _asyncToGenerator(
                      /*#__PURE__*/ _regeneratorRuntime().mark(
                        function _callee8(branch, startDate) {
                  ...
                  sumTotals = function sumTotals(totals) {
                    return totals.reduce(function (acc, total) {
                      ...
                      return (
                        acc +
                        (((_total$ = total[0]) === null || _total$ === void 0
                          ? void 0
                          : _total$.total) || 0)
                      );
                    }, 0);
...
var salesBranchByBranch = (exports.salesBranchByBranch =
  /*#__PURE__*/ (function () {
    var _ref10 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee12(req, res) {
        var branch,
          ...
          salesByBranchPromises,
          salesByCashierPromises,
          salesByBranchResults,
          salesByCashierResults,
          mergeResults,
          salesByBranch,
          salesByCashier;
        return _regeneratorRuntime().wrap(
            ...
            while (1)
              switch ((_context12.prev = _context12.next)) {
                case 0:
                  ...
                  console.log(
                    "Aggregate Branch Sales function:",
                    aggregateBranchSales
                  );
                  aggregateCashierSales = /*#__PURE__*/ (function () {
                    var _ref12 = _asyncToGenerator(
                      /*#__PURE__*/ _regeneratorRuntime().mark(
                        function _callee11(branch) {
                ...
                case 25:
                  ...
                  console.error(
                    "Error fetching grouped sales data:",
                    _context12.t0
                  );
                  res.status(500).json({
                    error: "Failed to fetch grouped sales data",
